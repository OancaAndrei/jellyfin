...
namespace MediaBrowser.Controller.SyncPlay
{
    ...
    public class GroupAccessList
    {
        ...
        /// The access list.
        /// </summary>
        private readonly Dictionary<Guid, UserGroupAccess> _accessList;
        ...
        public GroupAccessList()
        {
            ...
            _accessList = new Dictionary<Guid, UserGroupAccess>();
        }
        ...
        public IReadOnlyList<PlaybackRequestType> PlaybackRequests { get; } = new List<PlaybackRequestType>
        {
            ...
            PlaybackRequestType.NextTrack,
            PlaybackRequestType.PreviousTrack
        };
        ...
        public void TouchPermissions(Guid userId)
        {
            ...
            {
                _accessList[userId] = new UserGroupAccess(OpenPlaybackAccess, OpenPlaylistAccess);
            }
        }
        ...
        {
            _accessList[userId] = new UserGroupAccess(playbackAccess, playlistAccess);
        }
        ...
        public IReadOnlyDictionary<Guid, UserGroupAccess> GetAccessList()
        {
            return _accessList;
        }
        ...
        public bool CheckRequest(SessionInfo session, IGroupPlaybackRequest request)
        {
            ...
            bool isAlwaysAllowedRequest = AllowedRequests.Contains(request.Type);

            if (isAlwaysAllowedRequest)
            {
                return true;
            }
            else if (_accessList.TryGetValue(session.UserId, out UserGroupAccess userAccess))
            {
                bool needsPlaybackAccess = PlaybackRequests.Contains(request.Type);
                bool needsPlaylistAccess = PlaylistRequests.Contains(request.Type);
